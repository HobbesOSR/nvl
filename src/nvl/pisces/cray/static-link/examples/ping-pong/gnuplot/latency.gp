...
plot "native_linux_rdma.txt" using 1:2     title  "Native Linux RDMA" with linespoints ls 1, \
     ...
     "kitten_proxy_rdma.txt" using 1:2     title  "KITTEN PROXY RDMA" with linespoints ls 3,\
     "kitten_proxy_fma.txt" using 1:2     title  "KITTEN PROXY FMA" with linespoints ls 4
