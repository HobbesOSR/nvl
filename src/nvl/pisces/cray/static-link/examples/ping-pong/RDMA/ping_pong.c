...
main (int argc, char **argv)
{
  ...
  gather (&my_memory_handle, remote_memory_handle_array, sizeof (mdh_addr_t));
...
/*
	  ...
	  rdma_data_desc[i].length = TRANSFER_LENGTH;
